...
export default function PrivateLeaguesPage() {
    ...
    return (
        <main className="min-h-screen bg-slate-100">
            <div className="mx-auto max-w-7xl px-3 py-4 sm:px-6 sm:py-8 md:py-10">
                <header className="mb-4 overflow-hidden rounded-2xl border border-slate-800 bg-slate-950 text-white shadow-lg sm:mb-7">
                    <div className="border-b border-slate-800 px-4 py-3 sm:px-6 sm:py-4 md:px-8">
                        <div className="flex flex-wrap items-center justify-between gap-3">
                            ...
                            <div className="flex gap-2">
                                <button
                                    ...
                                    className="rounded-lg border border-slate-700 bg-slate-900 px-3 py-2 text-xs font-black text-white transition hover:border-teal-400 hover:text-teal-300 sm:px-4 sm:text-sm"
                                >
                                    Join League
                                </button>
                                ...
                                <button
                                    ...
                                    className="inline-flex items-center gap-1.5 rounded-lg bg-teal-500 px-3 py-2 text-xs font-black text-slate-950 transition hover:bg-teal-400 disabled:cursor-not-allowed disabled:opacity-50 sm:gap-2 sm:px-4 sm:text-sm"
                                >
                    ...
                    <div className="grid lg:grid-cols-[1fr_320px]">
                        <div className="p-4 sm:p-6 md:p-8">
                            ...
                            <h1 className="mt-1 text-3xl font-black tracking-tight sm:mt-2 sm:text-4xl md:text-5xl">
                                Private Leagues
                            </h1>
                ...
                <section className="mb-4 overflow-hidden rounded-2xl border border-slate-300 bg-white shadow-sm sm:mb-7">
                    ...
                    <div className="grid gap-3 p-4 sm:grid-cols-2 sm:gap-4 sm:p-5">
                        <div>
                            ...
                            <select
                                ...
                                className="mt-1.5 w-full rounded-lg border border-slate-300 bg-white px-3 py-2.5 text-sm text-slate-900 outline-none focus:border-teal-700 focus:ring-2 focus:ring-teal-100 disabled:cursor-not-allowed disabled:bg-slate-100 sm:mt-2 sm:px-4 sm:py-3 sm:text-base"
                            >
                                {seasons.length === 0 ? (
                                    <option value="">
                ...
                {!changing && selectedLeague && (
                    <>
                        <section className="mb-4 overflow-hidden rounded-2xl border border-slate-300 bg-white shadow-sm sm:mb-6">
                            <div className="border-b border-slate-800 bg-slate-950 px-4 py-3.5 text-white sm:px-5 sm:py-4">
                                <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between sm:gap-4">
                                    ...
                                    <div className="flex flex-wrap items-center gap-2">
                                        <div className="min-w-0 flex-1 rounded-lg border border-slate-700 bg-slate-900 px-3 py-2 sm:flex-none sm:px-4">
                                            <div className="flex flex-wrap items-center gap-2">
                                        ...
                                        <button
                                            ...
                                            className="inline-flex h-11 items-center justify-center rounded-lg border border-slate-700 bg-slate-900 px-3 text-xs font-black text-slate-200 transition hover:border-teal-400 hover:text-teal-300 sm:text-sm"
                                        >
                                            League Details
                                        </button>
                                    </div>
                                ...
                                <div className="mt-3 flex flex-wrap items-center gap-2 sm:mt-4">
                                    ...
                                    {tab === "round" && (
                                        <select
                                            ...
                                            className="h-10 min-w-0 flex-1 rounded-lg border border-slate-700 bg-slate-900 px-3 text-xs font-bold text-white outline-none transition focus:border-teal-400 focus:ring-2 focus:ring-teal-400/20 disabled:cursor-not-allowed disabled:opacity-60 sm:min-w-40 sm:flex-none sm:text-sm"
                                        >
                        ...
                        <section className="mb-4 overflow-hidden rounded-2xl border border-slate-300 bg-white shadow-sm sm:mb-6">
                            <div className="flex flex-col gap-3 border-b border-slate-800 bg-slate-950 px-4 py-3.5 text-white sm:flex-row sm:items-center sm:justify-between sm:gap-4 sm:px-5 sm:py-4">
                                <div>
                                    <div className="flex flex-wrap items-center gap-2">
                            ...
                            {leagueCupsLoading ? (
                                ...
                                <div className="divide-y divide-slate-200">
                                    {leagueCups.map((cup) => (
                                        <div
                                            key={cup.id}
                                            className="flex flex-col gap-3 px-4 py-3.5 sm:flex-row sm:items-center sm:justify-between sm:gap-4 sm:px-5 sm:py-4"
                                        >
                                            ...
                                            <div className="flex flex-wrap items-center gap-2">
                                                {selectedLeague.is_owner && (
                                                    <Link
                                                        ...
                                                        className="inline-flex flex-1 items-center justify-center rounded-lg bg-teal-600 px-3 py-2.5 text-xs font-black text-white transition hover:bg-teal-700 sm:flex-none sm:px-4 sm:text-sm"
                                                    >
                                                        Manage Cup
                                                    </Link>
                                                )}
                                                ...
                                                <Link
                                                    ...
                                                    className="inline-flex flex-1 items-center justify-center rounded-lg bg-slate-950 px-3 py-2.5 text-xs font-black text-white transition hover:bg-slate-800 sm:flex-none sm:px-4 sm:text-sm"
                                                >
                                                    View Cup
                                                </Link>
                                            </div>
